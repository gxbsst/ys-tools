...
export default class ClewForm extends PureComponent {
  ...
  render() {
    ...
    id = hasPermission(enterMap.find((value) => value.url == id).permissions, permissions) ? id : 'clewPool';
            ...
            <Row gutter={16}>
              <Col lg={8} md={12} sm={24}>
                <Form.Item {...formItemLayout} label={customerFieldLabels.customerType}>
                  {getFieldDecorator('customerType', {
                    ...
                    <Select placeholder="请选择客户类型" onChange={this.customerTypeChange}>
              ...
              <Col lg={8} md={12} sm={24}>
                <Form.Item {...formItemLayout} label={
                  ...
                  {getFieldDecorator(customerInfo, {
                    rules: [{ required: formRequired[customerInfo], message: `请填写 ${customerFieldLabels[customerInfo]}` }],
                  })(
                    <Input/>
                  )}
                </Form.Item>
              ...
              <Col lg={8} md={12} sm={24}>
                <Form.Item {...formItemLayout} label={customerFieldLabels.manageArea}>
                  {getFieldDecorator('manageArea')(<Input/>)}
                </Form.Item>
              </Col>
              <Col lg={8} md={12} sm={24}>
              ...
              <Col lg={8} md={12} sm={24}>
                <Form.Item {...formItemLayout} label={customerFieldLabels.shopName}>
                  {getFieldDecorator('shopName', {
                    rules: [{ required: formRequired.shopName, message: `请选择 ${customerFieldLabels.shopName}` }]
                  })(<Input/>)}
                </Form.Item>
              </Col>
              <Col lg={8} md={12} sm={24}>
                <Form.Item {...formItemLayout} label={customerFieldLabels.manageProduct}>
                  {getFieldDecorator('manageProduct')(<Input/>)}
                </Form.Item>
              </Col>
              <Col lg={8} md={12} sm={24}>
                <Form.Item {...formItemLayout} label={customerFieldLabels.legalPerson}>
                  {getFieldDecorator('legalPerson')(<Input/>)}
                </Form.Item>
              </Col>
              <Col lg={8} md={12} sm={24}>
                <Form.Item {...formItemLayout} label={customerFieldLabels.qualificationType}>
                  {getFieldDecorator('qualificationType')(<Input/>)}
                </Form.Item>
              </Col>
              <Col lg={8} md={12} sm={24}>
                <Form.Item {...formItemLayout} label={customerFieldLabels.accountMainBody}>
                  {getFieldDecorator('accountMainBody')(<Input/>)}
                </Form.Item>
              </Col>
              <Col lg={8} md={12} sm={24}>
                <Form.Item {...formItemLayout} label={customerFieldLabels.starLevel}>
                  {getFieldDecorator('starLevel')(<Input/>)}
                </Form.Item>
              </Col>
              <Col lg={8} md={12} sm={24}>
