...
const proxy = {
  ...
  'GET /api/permissions':
    {
      ...
      'data': [{
        ...
        'treeName': '',
        'type': 0,
        'updateTime': '2018-11-05 11:05:02',
        'uri': ''
      }],
      'message': '处理成功'
    }
  ...
  'GET /api/role': {
    ...
    'data': [{
      'count': 1,
      'createTime': '2018-11-06 15:33:54',
      'id': 100141,
      'isDel': 0,
      'isMaster': 0,
      'name': '运营测试',
      'remark': '',
      'updateTime': '2018-11-06 15:33:54'
    }, {
      'count': 2,
      'createTime': '2018-11-01 10:35:33',
      'id': 100140,
      'isDel': 0,
      'isMaster': 0,
      'name': '审批管理角色',
      'remark': '',
      'updateTime': '2018-11-01 10:35:33'
    }],
    'pagination': {'page': 1, 'pageCount': 20, 'pageSize': 10, 'totalCount': 2}
  },
  ...
  'GET /api/rank': {
    ...
    'data': [{
      'achievement': 15.00,
      'area': 'A大部',
      'createTime': '2018-11-15 16:28:46',
      'createUser': 'cong.cheng',
      'id': 91,
      'name': '王三',
      'sign': '2018-11',
      'sort': 49,
      'type': 1,
      'updateTime': '2018-11-15 16:28:46',
      'updateUser': 'cong.cheng'
    }],
  ...
  'GET /api/announcement': {
    'code': 0,
    'data': [{
      'createTime': '2018-03-01 11:03:05',
      'createUser': 'mingran.zhang',
      'id': 10,
      'link': 'http://www.hao123.com',
      'title': '第吴个',
      'type': 2,
      'updateTime': '2018-03-01 15:45:41',
      'updateUser': 'mingran.zhang'
    }, {
      'createTime': '2018-01-24 14:36:18',
      'createUser': 'mingran.zhang',
      'id': 8,
      'link': 'http://www.baidu.com',
      'title': '第吴个',
      'type': 1,
      'updateTime': '2018-02-26 14:54:44',
      'updateUser': 'mingran.zhang'
    }, {
      'createTime': '2018-01-24 11:59:25',
      'createUser': 'mingran.zhang',
      'id': 7,
      'link': 'www.baidu.com',
      'title': '第二个',
      'type': 1,
      'updateTime': '2018-01-24 11:59:25',
      'updateUser': 'mingran.zhang'
    }, {
      'createTime': '2018-01-24 11:12:06',
      'createUser': 'mingran.zhang',
      'id': 5,
      'link': '很多人都在讨论老张和小张谁厉害，其实有很多细节可以说明的，比如神雕最后，老张表现出来的超高的武学天赋，还有他一下就把玄冥一老给擒住，而且，他让7个资质平平的小孩在20多岁时就名满天下，武功个个都至少准一流吧，试问整个金庸小说里有谁能把自己所有的徒弟在20多岁的时候都练成武林准一流的高手？就这说明老张的武功确实厉害！另外，在小张为老张疗伤的时候，原著这样写到\n    说话之间，将一股极浑厚、极柔和的九阳神功，从手掌上向张三丰体内传了过去。张\n三丰于刹那之间，只觉掌心中传来这股力道雄强无比，虽然远不及自己内力的精纯醇正，，，\n其实，张三丰，无论在武侠还是历史，都是响当当的一代宗师，我们后人对他都有着崇敬之情，我相信金老也是这样，所以，第一当仁不让',
      'title': '张三丰，无论在武侠还是历史，都是响当当的一代宗师',
      'type': 1,
      'updateTime': '2018-02-08 04:21:52',
      'updateUser': 'mingran.zhang'
    }],
    'pagination': {'page': 1, 'pageCount': 1, 'pageSize': 6, 'totalCount': 4}
  },
  'GET /api/portal': {
    'code': 0,
    'data': [{
      'createTime': '2017-02-28 12:20:20',
      'createUser': 'jzl',
      'id': 3,
      'name': 'rank',
      'status': 1,
      'updateTime': '2018-06-21 17:57:52',
      'updateUser': 'dasa'
    }, {
      'createTime': '2017-12-25 11:44:29',
      'createUser': 'jzl',
      'id': 2,
      'name': 'announcement',
      'status': 1,
      'updateTime': '2018-03-02 14:12:16',
      'updateUser': 'jzl'
    }, {
      'createTime': '2017-12-22 16:09:03',
      'createUser': 'jzl',
      'id': 1,
      'name': 'mien',
      'status': 1,
      'updateTime': '2018-04-27 11:06:38',
      'updateUser': 'jzl'
    }],
  ...
  'GET /api/message': {
    'code': 0,
    'data': [{
      'createTime': '2018-11-21 00:01:09',
      'id': 13683,
      'isDel': 0,
      'title': '你有一条线索被加急后，72小时未跟进，请尽快联系该客户。',
      'updateTime': '2018-11-21 00:01:09',
      'url': '/#/clew/clews/16170967411300/detail',
      'userName': 'xianlu.gu'
    }, {
      'createTime': '2018-11-21 00:01:07',
      'id': 13641,
      'isDel': 0,
      'title': '你有一条机会被加急后，72小时未跟进，请尽快联系该客户。',
      'updateTime': '2018-11-21 00:01:07',
      'url': '/#/arriveShop/chanceDetail/1175354/basic',
      'userName': 'xianlu.gu'
    }, {
      'createTime': '2018-11-21 00:01:07',
      'id': 13633,
      ...
      'title': '你有一条机会被加急后，72小时未跟进，请尽快联系该客户。',
      'updateTime': '2018-11-21 00:01:07',
      'url': '/#/arriveShop/chanceDetail/1175335/basic',
      'userName': 'xianlu.gu'
    }, {
      'createTime': '2018-11-21 00:01:06',
      'id': 13627,
      'isDel': 0,
      'title': '你有一条客户被加急后，72小时未跟进，请尽快联系该客户。',
      'updateTime': '2018-11-21 00:01:06',
      'url': '/#/aftersale/details/1000501/baseInfo',
      'userName': 'xianlu.gu'
    }, {
      'createTime': '2018-11-21 00:01:06',
      'id': 13625,
      ...
      'title': '你有一条客户被加急后，72小时未跟进，请尽快联系该客户。',
      'updateTime': '2018-11-21 00:01:06',
      'url': '/#/aftersale/details/1000498/baseInfo',
      'userName': 'xianlu.gu'
    }, {
      'createTime': '2018-11-21 00:01:06',
      'id': 13624,
      ...
      'title': '你有一条客户被加急后，72小时未跟进，请尽快联系该客户。',
      'updateTime': '2018-11-21 00:01:06',
      'url': '/#/aftersale/details/1000495/baseInfo',
      'userName': 'xianlu.gu'
    }],
    'pagination': {'page': 1, 'pageCount': 47, 'pageSize': 6, 'totalCount': 281}
  },
  ...
  'GET /api/mien': {
    ...
    'data': [{
      'content': '',
      'createTime': '2018-03-02 10:02:21',
      'createUser': 'xin.deng',
      'id': 34,
      'position': 3,
      'sort': 2,
      'updateTime': '2018-06-14 15:01:07',
      'updateUser': 'teng.liu'
    }, {
      'content': '',
      'createTime': '2018-03-30 14:40:21',
      'createUser': 'xin.deng',
      'id': 48,
      'position': 1,
      'sort': 4,
    ...
    'pagination': {'page': 1, 'pageCount': 1, 'pageSize': 10, 'totalCount': 2}
  },
  'GET /api/account': {
    'code': 0,
    'data': {
