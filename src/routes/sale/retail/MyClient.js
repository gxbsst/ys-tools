...
@connect(state => ({
  ...
  user: state.user,
  loading: state.loading.effects['saleRetail/queryCustomersList'],
...
export default class HighSeaList extends PureComponent {
  componentDidMount() {
    this.props.dispatch({
      type: 'saleRetail/queryCustomersList',
      payload: {
        page: 1,
        pageSize: 10,
        fromSource: 1,
              ...
              <FormItem>
                {getFieldDecorator('level')(
                  ...
                  >
                    ...
                    <Option value={4}><Stars count={4}/></Option>
                    <Option value={5}><Stars count={5}/></Option>
                  </Select>
                )}
              </FormItem>
            </Col>
